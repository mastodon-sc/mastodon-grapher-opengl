...
public class PointCloudFrame< V extends Vertex< E > & HasTimepoint & HasLabel, E extends Edge< V > > extends ViewFrame
{
			...
			final DataDisplayOptions optional )
	{
		...
		sidePanel.btnPlot.addActionListener( e -> plot( sidePanel.getGraphConfig(), featureModel ) );
	...
	private void plot( final FeatureGraphConfig graphConfig, final FeatureModel featureModel )
	{
		// TODO Auto-generated method stub
		System.out.println( "Plot with " + graphConfig ); // DEBUG
	}
